...
Using a stratified simple random sample with proportional allocation, we estimated the average of the median alumni earnings for public and private institutions separately. We stratified colleges by average annual cost because tuition and fees are closely related to institutional characteristics that likely affect alumni earnings, such as available resources, program quality, and student demographics. By dividing schools into low-cost (≤ \$20,000) and high-cost (\> \$20,000) groups, we ensured that both more affordable and more expensive institutions were proportionally represented in the sample.
